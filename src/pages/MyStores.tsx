...
const MyStores = () => {
  ...
  const [productToEdit, setProductToEdit] = useState<{ id: string; name: string; price: number; description: string | null; image_url: string | null } | null>(null);
  ...
  const openEditProductDialog = (product: { id: string; name: string; price: number; description: string | null; image_url: string | null }) => {
  ...
  const openDeleteProductDialog = (product: { id: string; name: string }) => {
